...
import { NUTRITION_GOALS } from "@/entities/settings/model/types";


export const SetSettingsModal = ({settingsStore} : any) => {
    const { 
        targetsModal, 
        parsedTargets,
        macroCalories,
        ...
        <>
            ...
            <form
              ...
              onSubmit={(event) => {
                ...
                if (settingsStore.setNutritionTargets) {
                  ...
                  settingsStore.setTargetCalories(parsedTargets.calories);
                }
                targetsModal.close();
              }}
            >
