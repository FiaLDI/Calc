...
import { MEAL_TYPES, MealType, Product } from "@/entities/products/model/types";
...
export const  AddProductEntryForm = (
    {
        ...
        dateStore: ReturnType<typeof useDateStore>;
        products: Product[];
    }
) => {
  ...
  return (
    <form
        ...
        onSubmit={(event) => {
            ...
            productsStore.addEntry(selectedProductId, amountMultiplier, mealType, dateStore.selectedDate);
        }}
        >
        <div>
