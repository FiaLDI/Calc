    ...
    <div className="w-full rounded-4xl bg-white p-6 shadow-xl">
      ...
      >
        ...
        <button
          ...
          className="mt-2 w-full rounded-2xl bg-zinc-900 py-3 text-sm font-semibold text-white transition hover:bg-zinc-800 disabled:cursor-not-allowed disabled:bg-zinc-300"
        >
          Добавить продукт
        </button>
      </form>
